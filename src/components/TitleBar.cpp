...
TitleBar::TitleBar(Theme& theme, std::pair<int,int> size)
    : size(size),
      theme(theme),
      closeButton(" ", theme, std::pair<int,int>{size.second - 4, size.second - 4},
                  std::pair<int,int>{size.first - (size.second + 2), 2}),
      resizeButton(" ", theme, std::pair<int,int>{size.second - 4, size.second - 4},
                   std::pair<int,int>{size.first - (size.second + 2) * 2, 2}),
      minimizeButton(" ", theme, std::pair<int,int>{size.second - 4, size.second - 4},
                     std::pair<int,int>{size.first - (size.second + 2) * 3, 2}),
